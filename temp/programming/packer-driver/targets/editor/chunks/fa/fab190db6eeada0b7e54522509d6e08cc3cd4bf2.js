    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class GridManager extends Component {
        ...
        createGrid() {
          ...
          for (let row = this.levelConfig.length - 1; row >= 0; row--) {
            for (let col = this.levelConfig[row].length - 1; col >= 0; col--) {
...
//# sourceMappingURL=fab190db6eeada0b7e54522509d6e08cc3cd4bf2.js.map