    ...
    execute: function () {
      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = class GridManager extends Component {
        ...
        createGrid() {
          ...
          for (var row = this.levelConfig.length - 1; row >= 0; row--) {
            for (var col = this.levelConfig[row].length - 1; col >= 0; col--) {
              var type = this.levelConfig[row][col];
              console.log(type);
...
//# sourceMappingURL=906c11cb534ba54fc2041f17c7872fb3b89f8ace.js.map